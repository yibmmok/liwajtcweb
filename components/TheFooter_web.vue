<template>
	<footer class="w-full lg:w-full bg-violet-100">
        <div class="w-full lg:w-[1024px] mx-auto my-0">
            <div class="flex flex-col lg:flex-row">
                <div class="w-full lg:w-[300px]">
                    <div class="w-full flex flex-row">
                        <div class="w-[170px] pl-4">
                            <img src="../static/Logo.png" class="flex md:justify-self-start mx-4 my-2" width="100">
                            <div class="flex flex-row">
                                <div class="w-1/2">科學檢驗</div>
                                <div class="w-1/2">雙重保障</div>
                            </div>
                            <div class="flex flex-row">
                                <div class="w-1/2">中立客觀</div>
                                <div class="w-1/2">易於成交</div>
                            </div>
                        </div>
                    </div>
